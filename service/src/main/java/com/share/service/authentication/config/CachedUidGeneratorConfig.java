...
import com.share.service.authentication.uid.impl.CachedUidGenerator;
import com.share.service.authentication.uid.worker.DisposableWorkerIdAssigner;
...
public class CachedUidGeneratorConfig {
    ...
    public CachedUidGenerator cachedUidGenerator(DisposableWorkerIdAssigner disposableWorkerIdAssigner) {
        ...
        cachedUidGenerator.setEpochStr("2021-09-20");
